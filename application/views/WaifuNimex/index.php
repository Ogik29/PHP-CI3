...
<div class="container mt-4">
        ...
        <div class="row mt-4">
            <div class="col-md-4">
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    Waifu Nimex data <strong>success</strong> <?php echo $this->session->flashdata('flashAdd') ?>
        ...
        <div class="row mt-4">
            <div class="col-md-4">
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    Waifu Nimex data <strong>success</strong> <?php echo $this->session->flashdata('flashDelete') ?>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <a href="<?php echo base_url() ?>WaifuNimex/add" class="btn btn-dark mb-4 mr-2">Add Waifu</a>
            <a href="<?php echo base_url() ?>WaifuNimex/gacha" class="btn btn-info mb-4">Gacha Waifu</a>
        </div>
    </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card border-light bg-secondary text-light" style="width: 20rem; height: 12rem;">
                    ...
                    <div class="card-body mb-5">
                        <h5><a href="<?php echo base_url() ?>WaifuNimex/detail/<?php echo $w['id'] ?>" class="card-link badge badge-info">Waifu details</a></h5>
                        <h5><a href="<?php echo base_url() ?>WaifuNimex/update/<?php echo $w['id'] ?>" class="card-link badge badge-success tombolUpdate mt-2">Update<a></h5>
                        <h5><a href="<?php echo base_url() ?>WaifuNimex/delete/<?php echo $w['id'] ?>" class="card-link badge badge-danger mt-2" onclick="return confirm('Rill kh cuy?');">Delete</a></h5>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
